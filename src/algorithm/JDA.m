function [acc,acc_ite,A,mmd_iter] = JDA(X_src,Y_src,X_tar,Y_tar,options)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%% Iteration
	for i = 1 : T
		[Z,A,mmd] = JDA_core(X_src,Y_src,X_tar,Y_tar_pseudo,options);
        ...
        fprintf('JDA+NN=%0.4f\n',acc);
        acc_ite = [acc_ite;acc];
        mmd_iter = [mmd_iter;mmd];
	end

end

function [Z,A,mmd] = JDA_core(X_src,Y_src,X_tar,Y_tar_pseudo,options)
	%% Set options
